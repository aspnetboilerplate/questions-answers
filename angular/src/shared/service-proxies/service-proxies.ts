...
export class QuestionServiceProxy {
     ...
     * @return Success
     */
    getQuestions(maxResultCount: number | undefined, skipCount: number | undefined, sorting: string | undefined): Observable<QuestionDtoPagedResultDto> {
    ...
    protected processGetQuestions(response: HttpResponseBase): Observable<QuestionDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getQuestion(incrementViewCount: boolean | undefined, id: number | undefined): Observable<GetQuestionOutput> {
        let url_ = this.baseUrl + "/api/services/app/Question/GetQuestion?";
        if (incrementViewCount === null)
            throw new Error("The parameter 'incrementViewCount' cannot be null.");
        else if (incrementViewCount !== undefined)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetQuestion(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<GetQuestionOutput>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetQuestionOutput>;
        }));
    }
    ...
    protected processGetQuestion(response: HttpResponseBase): Observable<GetQuestionOutput> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetQuestionOutput.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    voteUp(body: EntityDto | undefined): Observable<VoteChangeOutput> {
        let url_ = this.baseUrl + "/api/services/app/Question/VoteUp";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processVoteUp(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processVoteUp(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<VoteChangeOutput>;
                }
            } else
                return _observableThrow(response_) as any as Observable<VoteChangeOutput>;
        }));
    }

    protected processVoteUp(response: HttpResponseBase): Observable<VoteChangeOutput> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = VoteChangeOutput.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    voteDown(body: EntityDto | undefined): Observable<VoteChangeOutput> {
        let url_ = this.baseUrl + "/api/services/app/Question/VoteDown";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processVoteDown(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processVoteDown(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<VoteChangeOutput>;
                }
            } else
    ...
    protected processVoteDown(response: HttpResponseBase): Observable<VoteChangeOutput> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    submitAnswer(body: SubmitAnswerInput | undefined): Observable<SubmitAnswerOutput> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSubmitAnswer(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<SubmitAnswerOutput>;
                }
            } else
                return _observableThrow(response_) as any as Observable<SubmitAnswerOutput>;
        }));
    }
    ...
    protected processSubmitAnswer(response: HttpResponseBase): Observable<SubmitAnswerOutput> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = SubmitAnswerOutput.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    acceptAnswer(body: EntityDto | undefined): Observable<void> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAcceptAnswer(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
...
export class GetQuestionOutput implements IGetQuestionOutput {
    ...
    init(_data?: any) {
        if (_data) {
            this.question = _data["question"] ? QuestionWithAnswersDto.fromJS(_data["question"]) : <any>undefined;
        }
    }

...
namespace QuestionsAnswers.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = QuestionsAnswersConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(QuestionsAnswersDbContext context)
        {
            _context = context;
        }
